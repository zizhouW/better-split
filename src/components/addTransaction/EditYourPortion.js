...
export const EditYourPortion = ({ shouldRender, baseAmount, onSubmit }) => {
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>Edit your portion</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <Text mb="4px" color="gray.300" fontSize="14px">Your current amount is&nbsp;
